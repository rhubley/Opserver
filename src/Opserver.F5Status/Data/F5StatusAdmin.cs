...
namespace Opserver.F5Status.Data
{
    public class F5StatusAdmin
    {
        ...
        public F5StatusAdmin(F5StatusModule module)
        {
            Module = module;
        }
        ...
        {
            var instances = new HashSet<F5StatusInstance>();
        ...
        private async Task<bool> PostAction(Proxy p, Server server, Action action)
        {
            ...
            // F5Status will not drain a downed server, do the next best thing: MAINT
