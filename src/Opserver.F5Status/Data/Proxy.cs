...
{
    /// <summary>
    /// Represents the a single proxy instance in F5Status including the Frontends, Servers, and Backends currently configured.
    /// </summary>
    public class Proxy : IMonitorStatus
    {
        [IgnoreDataMember]
        public F5StatusInstance Instance { get; internal set; }
